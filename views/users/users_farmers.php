  	...
  	<div class="container">
	   ...
	   <div class="col-md-9 single_right">
	    ...
	    <div class="related_products">
	     <div class="col-md-4 top_grid1-box1 top_grid2-box2"><a href="profile">
	     	<div class="grid_1">
	     	  ...
	     	  <div class="grid_2">
	     	  	...
	     	  	<ul class="grid_2-bottom">
	     	  		...
	     	  		<li class="grid_2-right"><a href="profile" title="Get It" class="btn btn-primary btn-normal btn-inline " target="_self">Get It</a></li>
	     	  		<div class="clearfix"> </div>
	     	  	</ul>
	     	  </div>
	     	</div>
